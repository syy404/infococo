...
$(document).ready(function () {
  ...
  function judge() {
    ...
    //——————特殊事件211 222
    if (
      (clickCount1 === 2 && clickCount2 === 1 && clickCount3 === 1) ||
      (clickCount1 === 2 && clickCount2 === 2 && clickCount3 === 2)
    ) {
      $(".fa1").hide();
      $(".mo1").hide();
      $(".chi1").hide();
    ...
    //——————特殊事件212 232
    if (
      (clickCount1 === 2 && clickCount2 === 1 && clickCount3 === 2) ||
      (clickCount1 === 2 && clickCount2 === 3 && clickCount3 === 2)
    ) {
      $(".fa1").hide();
      $(".mo1").hide();
      $(".chi1").hide();
    ...
    if (
      (clickCount1 === 3 && clickCount2 === 2 && clickCount3 === 1) ||
      (clickCount1 === 3 && clickCount2 === 2 && clickCount3 === 2) ||
      (clickCount1 === 3 && clickCount2 === 2 && clickCount3 === 3) ||
      (clickCount1 === 3 && clickCount2 === 3 && clickCount3 === 1) ||
      (clickCount1 === 3 && clickCount2 === 3 && clickCount3 === 2) ||
      (clickCount1 === 3 && clickCount2 === 3 && clickCount3 === 3)
    ) {
      $(".fa1").hide();
      $(".mo1").hide();
      $(".chi1").hide();
